...
\lstinputlisting[language=Java,firstlineandnumber=60,lastline=90,widthgobble=3,float,caption={Java implementation of RIM},label={lst:RIM}]{../sim/actor/NodeProcessorRIM.java}
